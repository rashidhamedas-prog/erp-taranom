...
| آخرین commit | `b017e88` (+ SW bump در حال deploy) |
| نسخه وب/دسکتاپ | **`1.0.11`** / SW `v46` |
| اندروید | **`2.0.10`** (versionCode 12) — **توزیع محلی فقط** |
| وضعیت سرور | ⏳ در حال deploy ایران `94.249.244.208` |
...
- **Deploy:** ⏳ git bundle → ایران (در حال اجرا)
