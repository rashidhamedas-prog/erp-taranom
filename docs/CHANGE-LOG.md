...
| آخرین commit | (در حال) حذف کامل کاربر + زیرساخت آپدیت/اعلان |
| نسخه وب/دسکتاپ | وب **`2.1.2`** / دسکتاپ **`2.0.3`** (بدون بیلد جدید) / SW `erp-taranom-v93` |
| اندروید | **`2.0.24`** آپدیت (نوتیفیکیشن) — sideload |
| وضعیت سرور | ⏳ deploy |
| سرور production | تنها ایران `94.249.244.208` |
| سیاست بیلد | تا دستور صریح: **بدون بیلد کامل** دسکتاپ؛ اندروید فقط به‌صورت آپدیت در صورت نیاز |
...
- **Deploy:** ⏳
- **یادداشت:** دسکتاپ بیلد نشد. اندروید 2.0.24 فقط اگر بیلد آپدیت گرفته شود.
