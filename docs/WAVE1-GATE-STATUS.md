...
| Pagination لیست‌های اصلی | ✅ | opt-in envelope + LIMIT؛ bare GET = کاتالوگ کامل (`listQueryPlan`) — customers/orders/followups/suppliers/persons/products/invoices |
...
Reviewer روی `0785648` ابتدا **Changes requested** (LIMIT ۵۰ خاموش روی bare GET) داد؛ اصلاح `listQueryPlan` روی همین شاخه — منتظر re-review.
