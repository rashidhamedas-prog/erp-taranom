#!/usr/bin/env python3
"""SFTP overlay stitch v170 (POS-03 + Phase 8). VPS cannot fetch GitHub. Do not replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v170"

FILES = [
    "docs/CHANGE-LOG.md",
    "docs/architecture/ADR-007-FABRIC-ROLL.md",
    "docs/architecture/STITCH-PHASE-8-HARDENING.md",
    ...
    "server/public/sw.js",
    "server/scripts/test-pos-03-report.js",
    "server/scripts/run-stitch-phase8-gates.js",
]
