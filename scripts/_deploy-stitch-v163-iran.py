#!/usr/bin/env python3
"""SFTP overlay stitch v163 (HR+INV+TRS). VPS cannot fetch GitHub. Do not replace db.js (VPS-dirty)."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v163"
...
FILES = [
    ...
    "server/lib/observability.js",
    "server/lib/user-invitations.js",
    "server/lib/inventory/product-line-search.js",
    "server/lib/product-variants/color-hex.js",
    "server/lib/product-variants/index.js",
    ...
    "server/routes/user-invitations.js",
    "server/routes/cheque-records.js",
    "server/routes/product-variants.js",
    "server/routes/products.js",
    "server/routes/warehouses.js",
    "server/scripts/test-hr-invite.js",
    "server/scripts/test-observability.js",
    "server/scripts/test-inv-stitch-p4.js",
    "server/scripts/test-trs-cheque-out.js",
    "server/server.js",
    "server/sync/capture.js",
    "scripts/_patch-user-invitations.js",
]
...
def main() -> None:
    ...
    code, patch_out = run(c, f"node {APP}/scripts/_patch-user-invitations.js", timeout=30)
    if code != 0 or not any(
        x in patch_out
        for x in ("DB_INVITE_PATCHED", "DB_INVITE_ALREADY", "DB_INVITE_COLUMNS_PATCHED", "DB_INVITE_TABLE_PATCHED_NO_COLUMNS")
    ):
        c.close()
        raise SystemExit("db.js invite patch failed")
