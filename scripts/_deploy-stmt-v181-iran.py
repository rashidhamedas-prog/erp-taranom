#!/usr/bin/env python3
"""SFTP overlay: dashboard align / search / live rolls v181. Never wholesale-replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-stmt-v181"
...
FILES = [
    ...
    "server/scripts/test-ops-v181.js",
