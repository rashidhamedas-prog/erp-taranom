#!/usr/bin/env python3
"""SFTP overlay: statement/dashboard/invoice v180. Never wholesale-replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-stmt-v180"
...
FILES = [
    ...
    "server/scripts/test-stmt-gl-cheque-v180.js",
]
