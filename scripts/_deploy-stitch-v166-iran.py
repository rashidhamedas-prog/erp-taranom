#!/usr/bin/env python3
"""SFTP overlay stitch v166 (LED). VPS cannot fetch GitHub. Do not replace db.js (VPS-dirty)."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v166"
...
FILES = [
    ...
    "server/lib/ledgers.js",
    "server/public/acc-nav.js",
    "server/public/app.js",
    "server/public/index.html",
    "server/public/sw.js",
    "server/routes/ledgers.js",
    "server/scripts/test-led-stitch-p9.js",
    "server/server.js",
]
