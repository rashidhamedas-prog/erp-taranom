#!/usr/bin/env python3
"""SFTP overlay stitch v164 (CON). VPS cannot fetch GitHub. Do not replace db.js (VPS-dirty)."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v164"
...
FILES = [
    ...
    "server/lib/consignments.js",
    "server/public/app.js",
    "server/public/index.html",
    "server/public/sw.js",
    "server/routes/consignments.js",
    "server/scripts/test-con-stitch-p7.js",
    "server/sync/capture.js",
    "server/sync/tables.js",
    "scripts/_patch-consignment-columns.js",
]
...
def main() -> None:
    ...
    code, patch_out = run(c, f"node {APP}/scripts/_patch-consignment-columns.js", timeout=30)
    if code != 0 or not any(x in patch_out for x in ("DB_CON_PATCHED", "DB_CON_ALREADY")):
        c.close()
        raise SystemExit("db.js consignment patch failed")
