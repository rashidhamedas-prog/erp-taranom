#!/usr/bin/env python3
"""SFTP overlay: OPS pack v179. Never wholesale-replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-ops-v179"

FILES = [
    "docs/CHANGE-LOG.md",
    ".ai-dos/tasks/handoff.md",
    "server/lib/cash-flow.js",
    "server/lib/gap-accounting-schema.js",
    "server/lib/inventory/fabric-rolls.js",
    "server/lib/inventory/schema.js",
    ...
    "server/scripts/test-ops-pack-v179.js",
]
...
def main() -> None:
    ...
    run(c, "pm2 restart erp-taranom --update-env 2>&1 | tail -15")
    _code, health = run(
        c,
        "sleep 12; "
