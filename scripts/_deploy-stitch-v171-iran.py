#!/usr/bin/env python3
"""SFTP overlay stitch v171 (PROD-01 fabric rolls). VPS cannot fetch GitHub. Do not replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v171"
...
FILES = [
    ...
    "server/scripts/test-prod-01-fabric-rolls.js",
