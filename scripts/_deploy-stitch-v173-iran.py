#!/usr/bin/env python3
"""SFTP overlay stitch v173 (PROD PACK + fabric lock). VPS cannot fetch GitHub. Do not replace db.js."""
...
STAMP_FILE = ".sftp-deploy-stamp-stitch-v173"
...
FILES = [
    ...
    "server/scripts/test-prod-stitch-pack.js",
    "server/server.js",
