...
run(
    ...
    "git stash push -m deploy-246a44c -- server/package-lock.json server/routes/products.js 2>/dev/null; "
    ...
    "grep -E \"title: '\" server/public/acc-nav.js | head -15 && "
    "grep -n erp-taranom-v113 server/public/sw.js"
)
c.close()
print("DONE")
