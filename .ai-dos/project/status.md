...
- **Active task:** `QA-ERP-FULL-CYCLE-FIX-HIGHS` + `QA-ERP-RBAC-MATRIX-ALIGN` (no deploy)
- **Parent:** `QA-ERP-FULL-CYCLE` still active (harness claim on `scripts/qa/**`)
- **Tip (in progress):** `ai/QA-ERP-FULL-CYCLE-FIX-HIGHS-product` worktree
  `D:/soft/Claud/porje/Run in the project/erp-taranom-qa-erp-fix-highs`
- Latest isolated QA `qa-20260824T214150-19348` (full E2E, no skip): exit **1** · PASS 218 · FAIL 18 · ERROR 0
  Cheque party_id tests PASS. Remaining FAILs classified as matrix/probe mismatch; rbac.js tightened.
