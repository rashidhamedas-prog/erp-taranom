...
- **UI-STITCH-IMPL + HR/INV/TRS + CON + POS:** CON Iran v164 @ `1a1bf0f`; POS dual APPROVED `7cab828` merged; Iran SFTP v165 next
- **Next (ADR-007 closed):** Iran SFTP POS v165, then LED-01 + Phase 8.
