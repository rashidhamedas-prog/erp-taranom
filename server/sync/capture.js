...
const PATH_TABLE_MAP = [
  ...
  ['/api/purchases/goods-receipts', 'goods_receipts'],
  ['/api/purchases/orders', 'purchase_orders'],
  ['/api/purchases/three-way-match', 'three_way_matches'],
  ['/api/purchases/gr-invoices', 'purchase_invoices'],
