...
router.post('/webhooks', auth, adminOnly, centralOnly, (req, res) => {
...
router.put('/webhooks/:id', auth, adminOnly, centralOnly, (req, res) => {
...
router.delete('/webhooks/:id', auth, adminOnly, centralOnly, (req, res) => {
